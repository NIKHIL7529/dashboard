export default function ProjectItem({ project }) {
  return (
    <div className="bg-white shadow-md rounded-md px-8 py-5 mb-4">
      ...
      <div className="grid grid-cols-3 gap-4 mt-6 mb-6">
        ...
        <div className="flex items-center justify-center bg-[#f9faf5] cursor-pointer">
          <i class="fa-solid fa-circle-plus text-[#f9faf5] border-2 border-[#dadbd6] bg-[#dadbd6] rounded-full text-5xl "></i>
        </div>
      </div>
    </div>
  );
